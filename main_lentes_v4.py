...
from deteccion_lentes_v4 import detect_glasses
...
def process_drive_folder_with_detector_v2(
    ...
    # --- MODIFICACIÓN: FASE 2: Detección con detect_glassesor ---
...
if __name__ == "__main__":
    ...
    try:
        ...
        output_path = f"/content/drive/MyDrive/colab/Reporte_v4_{get_file_count('results')+1}.xlsx"
